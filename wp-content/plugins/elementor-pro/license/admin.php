...
class Admin {
		...
		<div class="notice elementor-message">
			<div class="elementor-message-inner">
				...
				<div class="elementor-message-action">
					<a class="button elementor-button" href="<?php echo esc_attr( $button_url ); ?>"><?php echo esc_html( $button_text ); ?></a>
				</div>
				<?php endif; ?>
			</div>
		</div>
	...
	private function handle_dashboard_admin_widget() {
		...
		add_filter( 'elementor/admin/dashboard_overview_widget/footer_actions', function( $additions_actions ) {
			...
			$additions_actions['my_account'] = [
				'title' => __( 'My Account', 'elementor-pro' ),
				'link' => 'https://go.elementor.com/overview-widget-account/',
			];
